# BORG x ATLAS CROSS-SYSTEM INTELLIGENCE REPORT
...
| **Borg Backlog** | borg.db links_backlog | 15,753 | 6,116 | N/A |
| **Borg Tools** | borg.db tools | 651 | N/A | N/A |
| **Borg MCP Servers** | borg.db mcp_servers | 68 | N/A | N/A |
| **Borg Sessions** | borg.db imported_sessions | 9,774 | N/A | N/A |
| **Borg Memories** | borg.db imported_session_memories | 22,749 | N/A | N/A |

### Cross-Reference Overlap

- **Shared repos** (in both systems): **4,664**
- **Atlas-only** repos: **255** -- candidates for Borg assimilation
- **Borg-only** repos: **1,452** -- candidates for Atlas ingestion

---

## 2. BORG CODEBASE STATUS vs FEATURE ASSESSMENT
...
## 3. TOP ASSIMILATION CANDIDATES (Atlas -> Borg)
...
atlas.db (7,944 entries)
  |
  +-> high-signal MCP servers --> borg.db mcp_servers (68 -> ~120)
  |                            --> borg.db tools (651 -> ~900)
  |
  +-> architecture gap repos --> borg.db links_backlog (15,753 -> 15,900)
  |                            --> borg.db skill_candidate_queue
  |
  +-> innovation top-100 --> .hypercode/skills/ (0 -> curated set)

borg.db (15,753 backlog entries)
  |
