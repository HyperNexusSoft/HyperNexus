...
Next.js 15 App Router landing page for agentmemory. Lamtormentnexushini-inspired
...
`npx getdesign@latest add lamtormentnexushini`). Colors, type, spacing rules live
