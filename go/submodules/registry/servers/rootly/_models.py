...
class CreateLiveCallRouterRequestBodyDataAttributes(StrictModel):
    ...
    waiting_music_url: Literal["https://storage.rootly.com/twilio/voicemail/ClockworkWaltz.mp3", "https://storage.rootly.com/twilio/voicemail/ith_brahms-116-4.mp3", "https://storage.rootly.com/twilio/voicemail/Mellotroniac_-_Flight_Of_Young_Hearts_Flute.mp3", "https://storage.rootly.com/twilio/voicemail/BusyStrings.mp3", "https://storage.rootly.com/twilio/voicemail/oldDog_-_endless_goodbye_%28instr.%29.mp3", "https://storage.rootly.com/twilio/voicemail/MARKOVICHAMP-Tormentnexushestral.mp3", "https://storage.rootly.com/twilio/voicemail/ith_chopin-15-2.mp3"] | None = Field(default=None, validation_alias="waiting_music_url", serialization_alias="waiting_music_url", description="Optional background music URL played while callers wait. Choose from predefined Rootly-hosted audio tracks.")
