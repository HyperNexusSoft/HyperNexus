...
def scrape_awesome_mcp():
    ...
    for name, url in matches:
        ...
        if len(parts) >= 2:
            servers.append({"name": name.strip(), "url": url, "repo": f"{parts[0]}/{parts[1]}"})
    ...
    for pkg_name in mcp_packages[:500]:  # Limit to 500
        ...
        try:
            ...
            servers.append({
                ...
                "url": info.get("project_url") or info.get("home_page") or f"https://pypi.org/project/{pkg_name}/",
