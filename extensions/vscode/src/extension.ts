...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand('tormentnexus.openDashboard', openDashboard),
    ...
    context.subscriptions.push(
        vscode.window.registerTreeDataProvider('tormentnexus.memory', memoryProvider),
        vscode.window.registerTreeDataProvider('tormentnexus.tools', toolsProvider),
        vscode.window.registerTreeDataProvider('tormentnexus.status', statusProvider)
    );
...
class MemoryTreeProvider implements vscode.TreeDataProvider<vscode.TreeItem> {
    ...
    async getChildren(element?: vscode.TreeItem): Promise<vscode.TreeItem[]> {
        if (!isConnected) {
            return [new vscode.TreeItem('Not connected', vscode.TreeItemCollapsibleState.None)];
        }
        ...
        try {
            ...
            return [new vscode.TreeItem('Error loading memory', vscode.TreeItemCollapsibleState.None)];
        }
    }
}
...
class ToolsTreeProvider implements vscode.TreeDataProvider<vscode.TreeItem> {
    ...
    async getChildren(element?: vscode.TreeItem): Promise<vscode.TreeItem[]> {
        ...
        try {
            ...
            return [new vscode.TreeItem('Error loading tools', vscode.TreeItemCollapsibleState.None)];
        }
    }
}
...
class StatusTreeProvider implements vscode.TreeDataProvider<vscode.TreeItem> {
    ...
    async getChildren(element?: vscode.TreeItem): Promise<vscode.TreeItem[]> {
        if (!isConnected) {
            return [new vscode.TreeItem('⚪ Disconnected', vscode.TreeItemCollapsibleState.None)];
        }
